...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        #url2 = "https://impc.dlr.de/SWE/Total_Electron_Content/TEC_Near_Real-Time/Global/latest/tec_Global_NC.png"
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "SPACE WEATHER MONITORING AND FORCASTING Center @SSGI"))
    ...
    def __init__(self) -> None:
        ...
        self.webview.load(
          #  QUrl("https://www.youtube.com/embed/wQGR81PxBxM")
           QUrl("https://www.youtube.com/embed/HJfy8acFaOg")
        )
